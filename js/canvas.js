...
//         this.alpha = generateDecimalBetween(1,5)/10;
...
//     }
//     canvasSize(){
//         this.canvasWidth = this.canvas.offsetWidth*this.dpr;
//         this.canvasHeight = this.canvas.offsetHeight*this.dpr;
//         this.ctx = ctx.scale(this.dpr, this.dpr);
...
// //  bubble.color хранится в формате трех цифр через запятую "255,108,80"), а fillStyle должен быть равен строке в другом формате: "rgba(0,0,0,1)".
